...
export default function AboutMe() {
  ...
  return (
    <section
      id="aboutMe"
      className="min-h-screen pt-16 grid grid-rows-5 border-b-4 border-gray-400 border-b-gray-200 bg-gradient-to-b from-10% from-gray-300 from-10% to-white md:pt-20 md:bg-gradient-to-r md:from-white md:via-gray-200 md:to-gray-500/70 md:h-[110vh]"
    >
      <div>

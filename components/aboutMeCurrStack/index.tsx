      ...
      <article className="px-4 gap-8 flex flex-col justify-center text-green-900 md:items-center md:grid md:grid-cols-12 md:py-2 md:py-8">
        ...
        >
          <div className="grid grid-cols-12 shadow-lg shadow-green-900 px-6 pb-6 bg-gradient-to-b from-white/90 to-white/10 md:gap-0 md:to-white/50 md:rounded-lg">
            <h3 className="col-span-12 text-3xl font-semibold text-green-900 flex flex-row gap-2 items-center justify-start py-8 underline underline-offset-4 md:py-4">
              <svg
            ...
            <div className="flex justify-evenly col-span-12 gap-4 md:gap-16 md:px-12">
              <div className="col-span-6 flex flex-col gap-4">
                <div className="flex flex-row items-center gap-2">
                  ...
                  <h4 className="text-xl font-semibold text-green-800 underline decoration-wavy md:text-2xl">
                    Front-end:
                  </h4>
                </div>
